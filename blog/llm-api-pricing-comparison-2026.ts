...
<p>OpenAI's current flagship lineup has two tiers. GPT-5.5 runs $5.00 input / $30.00 output per million tokens, with a $0.50 cached-input rate. GPT-5.4 is the mid-tier option at $2.50/$15.00. Both step up to roughly double those rates once a request's input crosses a long-context threshold, around 270,000 tokens for the GPT-5.5/5.4 family.</p>
...
<p>Anthropic moved in the opposite direction at the flagship level. Opus dropped from $15.00/$75.00 (Opus 4.1) to $5.00/$25.00 across Opus 4.5 through 4.8, a 3x cut carried across four straight releases. Google's most consequential 2026 change was not a price cut but a free-tier restriction: Gemini Pro-class models lost free access entirely on April 1, 2026. That pushed anyone prototyping with Gemini 3.1 Pro onto a paid account, though Flash and Flash-Lite models kept a reduced free tier.</p>
...
<p>Anthropic's current Claude models (Sonnet 5, Sonnet 4.6, Opus 4.8, Opus 4.7, Opus 4.6) include their full 1M token context window at flat, standard pricing. There's no premium tier. That changes the calculus for any application working with large codebases, long documents, or extended conversation history.</p>
...
<p>At this volume, the spread between the cheapest budget-tier model and the most expensive flagship is roughly 64x. That's a bigger swing than most teams expect until they run the numbers. Note that this table does not include Sonnet 5's ~30% tokenizer overhead versus older Claude models. That overhead would push its real-world cost somewhat higher than the raw multiplication suggests. It also excludes caching: a chatbot with an 80% cache-hit rate on a shared system prompt could cut most of these totals by a third or more.</p>
