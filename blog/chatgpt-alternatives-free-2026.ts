...
<ul style="margin:12px 0 12px 24px;line-height:2.2;">
  <li><strong>Replace ChatGPT entirely:</strong> Use Gemini — it's the closest feature-for-feature match with a better free plan</li>
  <li><strong>Research and fact-checking:</strong> Use Perplexity — citations make it objectively better for anything requiring accuracy</li>
  <li><strong>Quick content generation:</strong> Use Rytr — the template approach beats prompt engineering for short-form content</li>
  <li><strong>SEO blog posts:</strong> Use Writesonic — the Article Writer produces more structured output than any chat interface</li>
</ul>
