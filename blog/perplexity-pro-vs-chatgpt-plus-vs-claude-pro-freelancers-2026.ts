...
const post: BlogPost = {
  ...
  excerpt: 'All three cost $20/month. All three promise to transform your workflow. But after running Perplexity Pro, ChatGPT Plus, and Claude Pro through the same five freelance tasks on the same day, it\'s clear they are not interchangeable. Here\'s which one wins for writing, research, editing, social media, and document summarisation, plus the honest truth about which tier is actually worth paying for.',
  faqs: [
    {
...
<p>None of the three wins every task. Perplexity Pro is worth it for research with sources, ChatGPT Plus for writing first drafts and brainstorming, and Claude Pro for editing and document summarisation. Which one is "worth it" for you depends entirely on which of those five tasks eats most of your week.</p>
...
<p>All three were independently researched through the same five tasks on the same day in May 2026. Same prompts, same brief, no editing the prompt to flatter any particular tool. The documented outputs are shown as-is: not ideal versions, not marketing copy, just what actually came out.</p>
...
<p>Prose quality is where Claude wins: voice, sentence rhythm, and not sounding like every other AI-written article on the internet. If that matters to you, Claude is the tool that gets it right most consistently. At $20/month for a freelance writer billing $2,000+ per month, that's noise-level cost for a real quality difference.</p>

<h3>Researchers, journalists, and analysts → Perplexity Pro</h3>
<p>If your work requires you to find current, verifiable information quickly and cite it accurately, nothing in this price tier competes with Perplexity. The citation system alone changes how you work. Honestly, try the free tier for two weeks first. If 5 Pro searches per day isn't enough, that's your signal to upgrade.</p>
