...
const post: BlogPost = {
  ...
  category: 'Writing',
  readTime: '8 min read',
  excerpt: 'Grammarly is great — but it\'s not always the right tool. After researching every major alternative across price, features, and real user feedback, here\'s what fits which workflow in 2026.',
  faqs: [
    {
