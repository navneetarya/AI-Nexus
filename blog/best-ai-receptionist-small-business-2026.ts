...
<img src="https://images.unsplash.com/photo-1606836591695-4d58a73eba1e?auto=format&fit=crop&w=1200&h=675&q=80&crop=entropy" alt="Colleagues having a business meeting in an office room" style="width:100%;aspect-ratio:16/9;object-fit:cover;border-radius:12px;margin:8px 0 24px;" loading="lazy" />
...
`,
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'Most tools in this category advertise 10–15 minutes for basic setup: connecting a phone number, describing your business, and letting the AI start answering calls with generic responses. Getting it genuinely reliable, with accurate hours, service-specific FAQs, and correctly configured calendar booking, typically takes an additional 1–3 hours spread over the first week as you catch and correct edge cases from real calls.',
    },
    {
      q: 'Will callers know they are talking to an AI, not a human?',
      a: 'Usually, yes, though voice quality has improved significantly. Most providers, including AIRA, Goodcall, and Smith.ai, recommend disclosing AI use at the start of the call both for caller trust and because several US states have introduced AI-disclosure requirements for automated phone interactions. Check your state\'s current rules before disabling any built-in disclosure setting.',
    },
    {
      q: 'Can an AI receptionist integrate with my existing calendar and CRM?',
      a: 'Most mid-tier and above plans support integration with Google Calendar, Outlook, and common CRMs like HubSpot or Salesforce, though the exact list varies by provider and plan tier. Budget options like the cheapest Dialzara and Rosie tiers sometimes limit integrations to a single calendar provider or require a booking-link workaround instead of a direct two-way sync. Confirm your specific calendar or CRM is supported before committing to an annual plan.',
    },
  ],
