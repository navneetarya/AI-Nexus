...
const post: BlogPost = {
  ...
  faqs: [
    ...
    { q: 'Can I use all three models without paying for three subscriptions?', a: 'Yes, via API access on pay-as-you-go pricing instead of flat subscriptions — see our full breakdown in the AI API pricing comparison. For most individuals, though, one or two flat-rate subscriptions are cheaper than metered API use unless usage is very light.' },
    { q: 'Does Claude Opus 4.8 have real-time web search?', a: 'Claude Pro has limited web search compared to Grok 4\'s native X/Twitter and live search integration. For research that depends on very recent events, Grok 4 or GPT-5.5\'s browsing mode currently has an edge over Claude.' },
    { q: 'Which model has the largest context window?', a: 'Among these three, Claude Opus 4.8 is built for the longest reliable context handling in practice — it maintains coherence across very long documents better than GPT-5.5 or Grok 4, even when raw context window sizes are similar on paper.' },
    { q: 'Is it worth paying for two AI subscriptions instead of one?', a: 'If you push AI hard across both long-form writing/coding and real-time research, Claude Pro plus ChatGPT Plus ($40/month combined) covers nearly every use case. For lighter or single-purpose use, picking the one subscription that matches your primary task is more cost-effective.' },
  ],
  proscons: {
    pros: [
  ...
  outboundCitations: [
    { url: 'https://openai.com/chatgpt/pricing/', label: 'OpenAI — ChatGPT Plus pricing' },
    { url: 'https://claude.com/pricing', label: 'Anthropic — Claude Pro pricing' },
    { url: 'https://x.ai/grok', label: 'xAI — Grok model overview' },
    { url: 'https://www.swebench.com/', label: 'SWE-bench — coding benchmark leaderboard' },
  ],
...
<div style="background:rgba(13,148,136,.08);border-left:4px solid #0D9488;padding:16px 20px;border-radius:8px;margin-bottom:24px;">
  ...
  <p style="margin:8px 0 0;font-size:15px;line-height:1.6;">There is no single winner. GPT-5.5 wins on breadth, Claude Opus 4.8 wins on depth, and Grok 4 wins on real-time data — the right pick depends on which of those three you need most.</p>
</div>
...
<p><a href="/tools/claude-ai/" style="color:#0D9488;font-weight:600;">→ Full Claude review</a></p>
...
<p><a href="/tools/grok-ai/" style="color:#0D9488;font-weight:600;">→ Full Grok review</a> &nbsp;·&nbsp; <a href="/blog/best-ai-chatbot-2026/" style="color:#0D9488;font-weight:600;">→ Best AI chatbot 2026: full 5-way comparison</a></p>
...
<ol style="margin:12px 0 16px 24px;line-height:1.9;">
  <li><strong>Choose Claude Pro (Opus 4.8)</strong> if your primary use cases are long-form writing, in-depth research, document analysis, or serious coding work. At $20/month it is the highest-value single subscription for knowledge workers who push AI hard.</li>
