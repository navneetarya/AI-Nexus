...
<ul style="margin:12px 0 12px 24px;line-height:2.2;">
  <li><strong>AI Email Generator:</strong> Drafts a complete email (subject line, preview text, body copy, and CTA) from a 1–2 sentence brief. Output quality is consistently usable with minor editing.</li>
  ...
  <li><strong>Send Time Optimization:</strong> Looks at each subscriber's open history to deliver their email at the time they're most likely to open it. Available from the Email Marketing plan.</li>
</ul>
<ul style="margin:12px 0 12px 24px;line-height:2.2;">
